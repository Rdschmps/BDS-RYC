...
final class Version20250218215119_FillingUser extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        $this->addSql('INSERT INTO user (username, password, email, balance, roles) VALUES 
            ("guilianuser", "$2y$12$jumfasi/9kVEGHIP9PQASe1tXU4PglHN3bs2MceYV7dlo4D6ykSFK", "guilian@example.com", 500.00, "[\"ROLE_USER\"]"),
            ("guilianadmin", "$2y$12$jFDzW0N8.SAo1lvLkabsd.S7.8PeHs59Q6km/jMukLCZPbYXuI3Tq", "guilian@example.com", 500.00, "[\"ROLE_ADMIN\"]");
        ');
