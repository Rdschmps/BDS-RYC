...
final class Version20250221013603 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO user (username, password, email, balance, profilePicture, roles) VALUES 
        ...
        $this->addSql('INSERT INTO cart (user_id, items, status, totalPrice, createdAt) VALUES 
        (1, \'{"1": 2, "2": 1}\', "validated", 149.99, NOW()),
        (2, \'{"3": 1, "4": 3}\', "validated", 249.99, NOW()),
        (3, \'{"2": 1, "5": 2}\', "pending", 99.99, NOW())
        ');

        $this->addSql('INSERT INTO invoice (transactionDate, amount, billingAddress, billingCity, billingPostalCode, user_id, cart_id) VALUES 
        ...
        $this->addSql('INSERT INTO article (name, description, price, supplierPrice, quantity, imageUrl, publishedAt) VALUES 
